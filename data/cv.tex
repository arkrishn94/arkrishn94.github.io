...
\cventry
  ...
  {
    \begin{itemize}
      \item Working on scaling core vector indexing algorithms for M365 Copilot search experiences within Substrate.
    \end{itemize}
  }
...
\cventry
  ...
  {
    \begin{itemize}
      \item Developed a novel query-routing mechanism for IVF-style vector indexes, reducing scanned data by 25\% vs.\ Google ScaNN algorithm (published in NeurIPS 2025).
...
\cventry
  ...
  {
    \begin{itemize}
      \item Designed Pinecone’s winning solution for the NeurIPS 2023 Big ANN Challenge (Out-of-Distribution track) in Rust, achieving 35K+ QPS on a 10M-sized index using 8 vCPUs and 16 GB RAM.
...
\cventry
  ...
  {
    \begin{itemize}
      \item Researched quantization techniques for similarity search advied by Edo Liberty (CEO and Founder).
    \end{itemize}
  }
